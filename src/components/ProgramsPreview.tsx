...
export function ProgramsPreview() {
  ...
  return (
    <section className="py-24 bg-gray-50 dark:bg-gym-navy/50 relative z-10 overflow-hidden transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <motion.h2 initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              className="text-4xl md:text-6xl font-heading font-black italic text-gym-navy dark:text-white uppercase">
              Elite <span className="text-gym-orange">Programs</span>
            </motion.h2>
            <p className="text-gray-600 dark:text-gray-400 font-body mt-4 max-w-xl">
              Choose your path. Each program is meticulously designed to break plateaus.
            </p>
          </div>
